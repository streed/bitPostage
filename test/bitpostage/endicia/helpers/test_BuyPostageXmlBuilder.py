...
from bitpostage.endicia.helpers.BuyPostageXmlBuilder import BuyPostageXmlBuilder
from bitpostage.endicia.helpers.BuyPostageXmlBuilder import InvalidCreditAmountError
