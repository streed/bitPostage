from bitpostage.endicia.requests.ChangePassPhraseRequest import ChangePassPhraseRequest
from bitpostage.endicia.builders.ChangePassPhraseXmlBuilder import ChangePassPhraseXmlBuilder
